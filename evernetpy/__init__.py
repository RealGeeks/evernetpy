...
from lookups import FIXED_NWMLS_LOOKUPS
...
AREAS = FIXED_NWMLS_LOOKUPS['SD'].values()
...
def get_new_listings(username, password, hours_previous=24, property_types=PROPERTY_TYPES, areas=AREAS):

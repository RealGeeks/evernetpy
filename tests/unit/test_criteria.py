...
def test_get_criteria_property_types_and_areas():
    output = [x for x in _get_criteria('foo','bar', property_types=[1,2], areas=[1,2])]
    assert output == [
...
def test_get_criteria_property_types_and_areas_and_cities():
    output = [x for x in _get_criteria('foo','bar', property_types=[1,2], areas=[1,2], cities=[1,2])]
    assert output == [
